...
class ServiceProvidersController extends Action {
    ...
    public function registerEntry(){
        ...
        else if(strlen($_POST['rg']) > 0 && strlen($_POST['uf']) == 2 && $_POST['apartamento'] != ''){
            $prestadores_servicos = Container::getModel('ServiceProviders');
            $prestadores_servicos->rg = $_POST['rg'];
            $prestadores_servicos->uf = $_POST['uf'];
    ...
    public function updateServiceProviderEntry(){
        $this->validateAuthentication();
        if($_POST['id_prestador_servico'] != '' && $_POST['apartamento'] != ''){
            $prestadores_servicos = Container::getModel('ServiceProviders');
    ...
    public function exportServiceProviders(){
        ...
        if($_POST['categoria'] == 'Cadastros' && $_POST['periodo'] == 'Todo o período' && $_POST['data-inicio'] == '' && $_POST['data-fim'] == ''){
		    ...
		    $arquivo = 'relacao_prestadores_servicos_cadastrados.xls';
            ...
            $html .= '<table border="1">';
            $html .= "<tr>";
            $html .= "<td colspan='4' style='$style_first_header'><h2>Relação de prestadores de serviços cadastrados</h2></td>";
            $html .= "</tr>";
            $html .= '<tr>';
            ...
            // Definindo o nome do arquivo que será exportado
            $arquivo = 'relacao_entrada_prestadores_servicos.xls';
            ...
            $html .= '<table border="1">';
            $html .= "<tr>";
            $html .= "<td colspan='7' style='$style_first_header'><h2>Registros de entrada de prestadores de serviços</h2></td>";
            $html .= "</tr>";
            $html .= '<tr>';
            $html .= "<td style='$style_second_header_name'><h4 style='$style_titile_header'>Nome</h4></td>";
            ...
            $html .= '</tr>';
            foreach($prestadores_servicos->getAllRegistersEntry() as $e){
            ...
            $prestadores_servicos->data_inicio = $_POST['data-inicio'];
            $prestadores_servicos->data_fim = $_POST['data-fim'];
            ...
            $html .= '<table border="1">';
            $html .= "<tr>";
            $html .= "<td colspan='7' style='$style_first_header'><h2>Registros de entrada de prestadores de serviços - $data_inicio até $data_fim</h2></td>";
            $html .= "</tr>";
            $html .= '<tr>';
            $html .= "<td style='$style_second_header_name'><h4 style='$style_titile_header'>Nome</h4></td>";
            $html .= "<td style='$style_second_header'><h4 style='$style_titile_header'>CPF / RG</h4></td>";
            ...
            $html .= "<td style='$style_second_header'><h4 style='$style_titile_header'>Saída</h4></td>";
            $html .= '</tr>';
            foreach($prestadores_servicos->getAllRegistersEntryFilter() as $e){
                if (!isset($e['data_saida'])) {
                    $data_saida = 'Saída em aberto';
                } else {
                    $data_saida = date('d/m/Y H:i', strtotime($e['data_saida']));
