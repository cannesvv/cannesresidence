...
class CarsController extends Action {
	...
	public function cars(){
        ...
        if(($_SESSION['nivel_acesso'] == 'administrador') || ($_SESSION['nivel_acesso'] == 'porteiro')){
           ...
           $this->view->registros_entrada = $veiculo->getAllVeiculosRegistersGeral($_SESSION['id']);
            ...
            $visitantes = Container::getModel('Visitors');
            $veiculo = Container::getModel('Cars');
            //echo $veiculo->getCountVagas($_SESSION['id'])['total_vagas'];
            //echo " - ";
            //echo $veiculo->getCountVeiculos($_SESSION['id'])['total_veiculos'];
            //exit;
    ...
    public function deleteCar(){
        ...
        if(isset($_POST['id_veiculo'])){
            $veiculo = Container::getModel('Cars');
            $veiculo->id_veiculo = $_POST['id_veiculo'];
            $veiculo->deleteCar();
            echo "<script>alert('Veículo excluído com sucesso!')</script>";
        }
        echo "<script> location.href = '/cars' </script>";
    }
    ...
    public function registerCar(){
        ...
        //lse if(strlen($_POST['cpf']) == 14 && $_POST['nome'] != ''){
        //   $visitantes = Container::getModel('Visitors');
        ...
        //   }
            ...
            $veiculo->id_vaga_garagem = $_POST['id_vaga_garagem'];
            $veiculo->dsc_veiculo = $_POST['dsc_veiculo'];
            $veiculo->cor_veiculo = $_POST['cor_veiculo'];
            $veiculo->placa_veiculo = $_POST['placa_veiculo'];
